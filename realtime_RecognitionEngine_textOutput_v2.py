...
class RecognitionEngine:
    def __init__(self, VStreamer, emotion_classifier, graph, queueSize=128, use_gpu=False, gpu_number=0):
        ...
        while True:
            ...
            if self.VStreamer.more():
                ...
                for face_coordinates in faces:
                    ...
                    draw_bounding_box(face_coordinates, rgb_image, percentage * np.asarray((83,221,108)))
